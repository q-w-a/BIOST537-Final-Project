...
km_plot <- ggsurvplot(fit.dfs, legend.title="Kaplan-Meier estimate of Disease-Free Survival",
...
ggsave("km_directive1.png", plot = km_plot$plot, width = 6, height = 4, dpi = 300)
```
